...
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
  <h2 style="color:#1a1a2e;border-bottom:2px solid #c9a96e;padding-bottom:8px">📬 新的客户咨询</h2>
...
async function sendAzureNotification(fields: Record<string, string>) {
  ...
  const notifyEmail = process.env.NOTIFY_EMAIL_CONTACT
  ...
  try {
    ...
    const result = await sdk.sendEmail({
      ...
      subject: `[官网咨询] ${fields['公司名称']} - ${fields['联系人']}`,
